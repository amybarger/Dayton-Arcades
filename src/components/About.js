...
export default function About() {
    return (
        <div>
            ...
            <p className="WhoWeAreP">"So many of us older electronic restorers are gone and retired. It is my wish to preserve this skill-set by teaching it to the next generation."</p>
